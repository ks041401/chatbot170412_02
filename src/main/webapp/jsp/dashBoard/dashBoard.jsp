        ...
        $.ajax({
				...
				success : function(data) {
					...
					{	
						...
						row += '<td style="text-align:center;width:100px;"><div class="tt" style="width:100px;display:inline-block;white-space:nowrap;text-overflow:ellipsis;overflow:hidden" title="대화내용12343151535">질문인식불가</div></td>';
